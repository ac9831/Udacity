    ...
    public Loader<String[]> onCreateLoader(int id, Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                try {
                    String jsonWeatherRes = NetworkUtils.getResponseFromHttpUrl(weatherReqUrl);
                    String[] weatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, jsonWeatherRes);
